...
?>
      <font size="6"
          ...
          <button class="button button1"><a href="dailyReport.php">Daily Reports</a></button>
          <button class="button button2"><a href="monthlyReport.php">Monthly Reports</a></button>
