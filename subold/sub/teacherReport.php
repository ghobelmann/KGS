...
$query = "SELECT DISTINCT sickdays.name_id, total_sick.name, sickdays.sub_id, personnel.sub_name, total_sick.name
    ...
    <table class="table table-bordered table-striped class=w3-table w3-blue">
     <thead>
      <tr>
       ...
       <th style="color:#000000">Total Days Gone</th>
