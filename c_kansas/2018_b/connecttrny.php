...
$sql="INSERT INTO tournament (id, tournament, par, yardage, event, date, uid, number_holes, comments, btyb, notes, course, slope, rating, leaderboard, non_varsity)
VALUES
...
,'$_POST[slope]','$_POST[rating]','$_POST[leaderboard]','$_POST[non_varsity]')";
