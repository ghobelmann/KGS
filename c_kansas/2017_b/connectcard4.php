...
card, tid, noteam, jv, front, back, total, uid, slope, rating, par)
VALUES
('$_POST[1]','$_POST[event]','$tmid1','$_POST[teetime]',
'$man21','$man41','$man61',
'$_POST[card]','$_POST[tid]', 
 '$noteam1', '$jv1', 
'0','0', '$total1', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')";
...
'$_POST[card]','$_POST[tid]', 
 '$noteam2', '$jv2', 
'0','0', '$total2', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')";
...
'$_POST[card]','$_POST[tid]', 
 '$noteam3', '$jv3', 
 '0','0', '$total3', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')";
if (!mysqli_query($conn,$sql))
  {
...
'$_POST[card]','$_POST[tid]', 
 '$noteam4', '$jv4', 
 '0','0', '$total4', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: ' . mysqli_error());
  }
...
'$_POST[card]','$_POST[tid]', 
 '$noteam5', '$jv5', 
 '0','0', '$total5', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: ' . mysqli_error());
  }
...
'$_POST[card]','$_POST[tid]', 
 '$noteam6', '$jv6',
 '0','0', '$total6', '$data[id]', '$_POST[slope]', '$_POST[rating]', '$_POST[par]')"; 
if (!mysqli_query($conn,$sql))
  {
  die('Error: ' . mysqli_error());
  }
