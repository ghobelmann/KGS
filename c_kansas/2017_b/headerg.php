...
<div class="container"> 
   ...
   <?php
         ...
         //       $sql = "SELECT paid from team  WHERE uid = '$userid' order by id desc";
           ...
           //   $row = mysqli_fetch_array( $result ) 
            ...
            //        if {
              //      $paid = '1' echo "Your account is paid, Thank You.";
             //       else{
             //          echo "To pay your account fill out invoice and mail in. Thank You.";
             //       }
...
<h2> <center> <a href="enterschedule.php">Enter My Tournament On Yearly Calendar</a></h2>         
...
echo "<table border='1'>";
echo "<tr><th><center>Edit Name or Date</th><th>Date</th>
<th><center>Edit Yardage</th><th><center>Edit Par</th><th><center>Enter Players</th>
<th><center>Print ScoreCards</th><th><center>Print Wall Sheets</th>
<th><center>Enter Scores 18</th><th><center>Enter Scores 9</th>
<th><center>View Entered Golfers</th><th><center>Results</th><th><center>Delete</th></tr>";
// keeps getting the next row until there are no more to get
while($row = mysqli_fetch_array( $result )) {
	// Print out the contents of each row into a table
  echo "<tr><td><Center>";
  ...
  echo "</td><td><CENTER>"; 
  echo '<a href="card.php">18 Hole</font></a>';
  echo "</td><td><CENTER>"; 
  echo '<a href="card9.php">9 Hole</font></a>';
  echo "</td><td><CENTER>"; 
