...
echo '<tr><td colspan="2" <h3>'.$tournament['tournament'].'</a></h3></td></tr><th>Team</th><th>Score</td>';
asort($totals);
...
$query = "SELECT player_1, jv, tournament, team, total, manualscore, front, back,
last6, last3, rank
FROM (SELECT player_1, jv, tournament, team, total, manualscore, front, back,
last6, last3,
...
WHERE `tournament` = '$tournament' AND `jv` != 'yes' GROUP by player_1
