...
WHERE scores.spam = '1' AND classification = 'Sand'
...
team.school, team.classification FROM scores
INNER JOIN team on scores.tmid = team.tmid
WHERE scores.spam = '1' AND classification = '1A'
AND `noteam` <> 'yes' AND `jv` != 'yes'" ;
$result=mysqli_query($conn,$sql);
$j=0;
...
team.school, team.classification FROM scores
INNER JOIN team on scores.tmid = team.tmid
WHERE scores.spam = '1' AND classification = '2A'
AND `noteam` <> 'yes' AND `jv` != 'yes'" ;
$result=mysqli_query($conn,$sql);
$j=0;
...
team.school, team.classification FROM scores
INNER JOIN team on scores.tmid = team.tmid
WHERE scores.spam = '1' AND classification = '3A'
AND `noteam` <> 'yes' AND `jv` != 'yes'" ;
$result=mysqli_query($conn,$sql);
$j=0;
