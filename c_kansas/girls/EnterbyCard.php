...
Back 9:  <input type="int" name="back1" size="3" value="0"/> 


JV <input type="checkbox" name="jv1" value="JV">
 <input type="checkbox" name="non_varsity" value="no">  <br>
...
Back 9:  <input type="int" name="back2" size="3" value="0"/> 


JV	             <input type="checkbox" name="jv2" value="JV"> 
 <input type="checkbox" name="non_varsity" value="no">  <br>
...
Back 9:  <input type="int" name="back3" size="3" value="0"/> 


JV	             <input type="checkbox" name="jv3" value="JV">
 <input type="checkbox" name="non_varsity" value="no">  <br>
...
Back 9:  <input type="int" name="back4" size="3" value="0"/> 


JV	             <input type="checkbox" name="jv4" value="JV"> 
 <input type="checkbox" name="non_varsity" value="no">  <br>
...
Back 9:  <input type="int" name="back5" size="3" value="0"/> 

JV	             <input type="checkbox" name="jv5" value="JV">
 <input type="checkbox" name="non_varsity" value="no">  <br>
...
Back 9: <input type="int" name="back6" size="3" value="0"/> 


JV	      <input type="checkbox" name="jv6" value="JV">
 <input type="checkbox" name="non_varsity" value="no">  <br>
