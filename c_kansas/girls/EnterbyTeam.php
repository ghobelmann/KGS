...
WHERE roster.tmid = '$team' AND active = '2' AND
trnyteams.tid = '$tid'";
...
<form action="connectcard4team.php" method="post" id="addForm">
    ...
    Rating: <input type="decimal" name="rating" size="5" value="<?php echo $rating ?>" readonly />
        Par: <input type="int" name="par" size="5" value="<?php echo $par ?>" readonly />
          Trny Stat:  <input type="int" name="status" size="5" value="<?php echo $status ?>" readonly />
                     ...
                     <br><br>
Player 1-----> 
  		      <input type="checkbox" name="status1" value="2"> 
<font color="red"> <b>
...
<input type="radio" name="status1" value="1" checked> Varsity
...
<input type="radio" name="status2" value="1" checked> Varsity
...
<br><hr>
Player 3-----> 
  		      <input type="checkbox" name="status3" value="2"> 
            <font color="red"><b>
Individual - If player is Not on a team (at least 4 Players Click this Box)</b></font> <br>
...
<input type="radio" name="status3" value="1" checked> Varsity
...
<br><hr>
Player 4-----> 
  		      <input type="checkbox" name="status4" value="2"> 
            <font color="red"><b>
Individual - If player is Not on a team (at least 4 Players Click this Box)</b></font> <br>
...
<input type="radio" name="status4" value="1" checked> Varsity
...
<br><hr>
Player 5-----> 
  		      <input type="checkbox" name="status5" value="2"> 
            <font color="red"><b>
Individual - If player is Not on a team (at least 4 Players Click this Box)</b></font> <br>
...
<input type="radio" name="status5" value="1" checked> Varsity
...
<br><hr>
Player 6-----> 
  		      <input type="checkbox" name="status6" value="2"> 
            <font color="red"><b>
Individual - If player is Not on a team (at least 4 Players Click this Box)</b></font> <br>
...
<input type="radio" name="status6" value="1" checked> Varsity
