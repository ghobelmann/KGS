        ...
        <div class="col-lg-2 mb-4">
          <div class="list-group">
            ...
            <a href="GolfStatsSheet.pdf" class="list-group-item">Download Stats Sheet</a>
             ...
             <a href="https://paypal.me/ksgolfscores?locale.x=en_US" class="list-group-item">Pay with Paypal</a>
             <a href="../W9.pdf" class="list-group-item">W-9 Form</a>
...
<th scope="col"><center>Player QR Code</th>
<th scope="col"><center>Delete</th></tr>';
...
while($row = mysqli_fetch_array( $result )) {
  ...
  echo "</td><td><CENTER>"; 
  echo '<a href="scorecards.php?id='.$row['id'].'">Round 1 -</font></a>';
   echo '<a href="scorecards2.php?id='.$row['id'].'">Round 2</font></a>';
     // echo '<a href="scorecardLong.php?id='.$row['id'].'">C3 </font></a>';
  echo "<td><CENTER>"; 
...
<div class="mc-field-group input-group">
    ...
    <ul><li><input type="checkbox" value="1" name="group[5469][1]" id="mce-group[5469]-5469-0"><label for="mce-group[5469]-5469-0">6A</label></li>
<li><input type="checkbox" value="2" name="group[5469][2]" id="mce-group[5469]-5469-1"><label for="mce-group[5469]-5469-1">5A</label></li>
<li><input type="checkbox" value="4" name="group[5469][4]" id="mce-group[5469]-5469-2"><label for="mce-group[5469]-5469-2">4A</label></li>
<li><input type="checkbox" value="8" name="group[5469][8]" id="mce-group[5469]-5469-3"><label for="mce-group[5469]-5469-3">3A</label></li>
<li><input type="checkbox" value="16" name="group[5469][16]" id="mce-group[5469]-5469-4"><label for="mce-group[5469]-5469-4">2A</label></li>
<li><input type="checkbox" value="32" name="group[5469][32]" id="mce-group[5469]-5469-5"><label for="mce-group[5469]-5469-5">1A</label></li>
<li><input type="checkbox" value="64" name="group[5469][64]" id="mce-group[5469]-5469-6"><label for="mce-group[5469]-5469-6">Sand</label></li>
</ul>
</div>
<div class="mc-field-group input-group">
...
<script type='text/javascript' src='//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='SCHOOL';ftypes[3]='text';}(jQuery));var $mcj = jQuery.noConflict(true);</script>
<!--End mc_embed_signup-->
...
$i = 1;
	...
	echo "</td><td><CENTER>"; 
	echo "<a href='teamRankings.php?classification=321A'>321A</a>";
