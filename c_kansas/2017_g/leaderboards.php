...
$query = "SELECT date, tournament

from scores GROUP by tournament order by date desc";
...
while($row = mysql_fetch_array( $result )) 
...

  {
	...
	echo '<a href="teamresults.php?tournament='.$row['tournament'].'">'.$row['tournament'].'</font></a>';
