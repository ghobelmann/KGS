...
$sql="INSERT INTO tournament (id, tournament, par, yardage, event, date, uid, number_holes, comments, btyb, notes, course, slope, rating, non_varsity)
VALUES
...
,'$_POST[slope]','$_POST[rating]','$_POST[non_varsity]')";
