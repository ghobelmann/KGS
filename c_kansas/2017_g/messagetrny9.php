...
$sql = "SELECT scores.front, scores.tmid, team.school FROM scores
...
$sql2 = "SELECT pid, tmid, front, tid  FROM `scores` 
...
while($row = mysqli_fetch_array( $result )) {
   ...
   ($par + (((scores.total-$rating)*113/$slope)))/2  as adj_score,
...
<tr><th><center> Place </th><th><center> Player Name </th> <th><center> Team</th><b>
<th><center> Total</th><th>Adjusted Score</th></b> </tr>';
