...
$sql="INSERT INTO tournament (id, tournament, par, yardage, event, date, uid, number_holes, comments, btyb, notes, course, slope, rating, 
rounds, leaderboard, non_varsity)
VALUES
('$trnysetup', '$_POST[tournament]', '$_POST[par]', '$_POST[yardage]','$_POST[event]','$_POST[date]',
'$userid','$_POST[number_holes]','$_POST[comments]','$_POST[btyb]','$_POST[notes]','$_POST[course]'
,'$_POST[slope]','$_POST[rating]','$_POST[rounds]','$_POST[leaderboard]','$_POST[non_varsity]')";
