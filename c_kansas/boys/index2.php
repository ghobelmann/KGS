...
if ($paid > "0") {
    echo "<h4>Your Account has been Paid, Thank You for supporting the development of this website.</h4>";
}    else

{
echo "<h4><a href='EI/index.php'>Click Here to Print and Pay Invoice, then all functions of website will be available to you.</a> <h4>" ;
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="">New Tournament <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="trnysetup.php">Setup New Tournament</a></li>
       
          </ul>
	</li>
  
         <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="">Existing Tournaments <span class="caret"></span></a>
          <ul class="dropdown-menu">
             <li>         
<?php
...
?> 
  ...
  $( function() {
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          ...
          <a href="tutorials/pictures.pdf">Help with Pictures----</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 mb-4">
          <div class="list-group">
            ...
            <a href="teamStats.php?tmid=<?php echo $tmid; ?>" class="list-group-item">Team Page</a>
   ...
   $query = "SELECT id, date, tournament from tournament ORDER by date desc"; 
...
<th scope="col"><center>Enter Scores</th>
...
//	echo "</td><td><CENTER>"; 
  ...
  echo "</td><td><CENTER>"; 
 // echo '<a href="card9.php?id='.$row['id'].'"">9 Hole</font></a>';
 // echo "</td><td><CENTER>"; 
...
?>
  ...
  <center><h1><strong>IMPORTANT</strong> Sign up For Newsletter!! </center></h1>
       ...
       <h3>Subscribe to New Email list- Old Group email will be discontinued this Spring!! Sign up Today.</h3> 
...
$sql = "SELECT avg(gir) as gir, avg(putts) as putts, avg(fairways) as fairways, 
avg(tfairways) as tfairways,
stats.pid, avg(Tputts) as tputts, avg(updown) as updown, avg(ss) as ss, avg(fairways) as avgfairways,
...
$i = 1;
	...
	echo "</td><td><CENTER>"; 
	echo round ($row['updown'], 1);
	echo "</td><td><CENTER>"; 
	echo round ($row['ss'], 1);
	echo "</td><td><CENTER>";
	echo round ($row['totputts'] / $row['hp'], 1);
	echo "</td><td><CENTER>";  
...
$sql = "SELECT sum(gir) as gir, sum(putts) as putts, avg(tfairways) as tfairways, 
avg(fairways) as fairways,
stats.pid, sum(Tputts) as tputts, sum(updown) as updown, sum(ss) as ss,
...
$i = 1;
	...
	echo "</td><td><CENTER>";  
	echo round ($row['fairways'] / $row['tfairways'], 1) * 100;
  echo "%";
  echo "</td><td><CENTER>";  
...
?>
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
               <h4>Individual and Team Rankings </h4>
              </h4>
              <p class="card-text">
...
$i = 1;
  ...
  $sql = "SELECT scores.tmid, avg(total) as aaaa from scores INNER JOIN team ON scores.tmid = team.tmid WHERE team.classification = '2A' AND $paid = '1'";
 //mysqli #2     
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row  
...
$i = 1;
  ...
  $sql = "SELECT scores.tmid, avg(total) as aaaa from scores INNER JOIN team ON scores.tmid = team.tmid WHERE team.classification = '1A' AND $paid = '1' ";
 //mysqli #2     
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row  
