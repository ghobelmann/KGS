 ...
 <center>    <h1> <b>Update Tournament Information</b>    </h1>
    ...
    Date: <input type="varchar" name="date" id="datepicker" size="15" value='<?php echo $date; ?>'/>
     Event: <input type="varchar" name="event" size="15" value='<?php echo $event; ?>'/> <br><br>
      Par: <input type="varchar" name="par" size="5" value='<?php echo $par; ?>'/>         <br>
      Coach ID # (To Give this Tournament to Another Coach): Check Coaches Directory for Coaches UID's <input type="varchar" name="uid" size="5" value='<?php echo $uid; ?>'/>    <br>
