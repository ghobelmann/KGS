...
if ($result->num_rows > 0) {
    ...
    echo "0 results";
           ...
           $output = "http://admin.kansasgolfscores.com/c_kansas/testing/hbyhTourney.php?tid=$trny";
...
<div align="center" ><h1><?php echo $tname;  ?> Tournament Results. <br>Brought to You By <br><?php echo $btyb; ?></h1>
...
<br>Course : <?php echo $course;  ?>  </h3>
                  <li class="mx-auto" >
           <?php   echo "<img src='../../../global_style/QR/php/qr_img.php?d=$output'>";   ?>
