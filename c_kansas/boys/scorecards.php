...
?>    
 ...
 <a href="http://admin.kansasgolfscores.com/c_kansas/boys/uploads/team/<?php echo $image; ?>" > <img class="img-fluid" 
            src="http://admin.kansasgolfscores.com/c_kansas/boys/uploads/team/<?php echo $image; ?> " alt="<?php echo $image; ?>" height="120" width="140"> </a>
...
INNER JOIN par ON scores.tid = par.course
 WHERE scores.tid = par.course AND tid = '".$tid."' AND round = 1 LIMIT 1";
