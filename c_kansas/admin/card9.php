...
define('hole8', 'hole8');
define('hole9', 'hole9');
define('hole10', 'hole10');
define('hole11', 'hole11');
define('hole12', 'hole12');
define('hole13', 'hole13');
define('hole14', 'hole14');
define('hole15', 'hole15');
define('hole16', 'hole16');
define('hole17', 'hole17');
define('hole18', 'hole18');
...
while($row = mysqli_fetch_array( $result )) {
	...
	echo "<tr><td>"; 
  echo '<a href="card9.php?pid='.$row['pid'].'&'.card.'='.$card.'">'.$row['player_1'].'</font></a>';
...
$dq = ($_POST[dq]) ? $_POST[dq] : $scores['dq'];
...
$ten = ($_POST[hole1]) ? $_POST[hole1] : $scores['hole1'];
$eleven = ($_POST[hole2]) ? $_POST[hole2] : $scores['hole2'];
$twelve = ($_POST[hole3]) ? $_POST[hole3] : $scores['hole3'];
$thirteen = ($_POST[hole4]) ? $_POST[hole4] : $scores['hole4'];
$fourteen = ($_POST[hole5]) ? $_POST[hole5] : $scores['hole5'];
$fifteen = ($_POST[hole6]) ? $_POST[hole6] : $scores['hole6'];
$sixteen = ($_POST[hole7]) ? $_POST[hole7] : $scores['hole7'];
$seventeen = ($_POST[hole8]) ? $_POST[hole8] : $scores['hole8'];
$eighteen = ($_POST[hole9]) ? $_POST[hole9] : $scores['hole9'];
...
".(( !$_POST['hole1'] ) ? "" : "`hole10` = '".$_POST[hole1]."', ")."
".(( !$_POST['hole2'] ) ? "" : "`hole11` = '".$_POST[hole2]."', ")."
".(( !$_POST['hole3'] ) ? "" : "`hole12` = '".$_POST[hole3]."', ")."
".(( !$_POST['hole4'] ) ? "" : "`hole13` = '".$_POST[hole4]."', ")."
".(( !$_POST['hole5'] ) ? "" : "`hole14` = '".$_POST[hole5]."', ")."
".(( !$_POST['hole6'] ) ? "" : "`hole15` = '".$_POST[hole6]."', ")."
".(( !$_POST['hole7'] ) ? "" : "`hole16` = '".$_POST[hole7]."', ")."
".(( !$_POST['hole8'] ) ? "" : "`hole17` = '".$_POST[hole8]."', ")."
".(( !$_POST['hole9'] ) ? "" : "`hole18` = '".$_POST[hole9]."', ")."
...
Withdrew:    <input type="checkbox" name="dq" value="WD"/>  
