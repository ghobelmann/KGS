...
<div id="wrapper">
  ...
  <div id="content">
       <div align="center" ><h1>KCA Rankings Top 5 Teams by Class</h1>
   <?php
...
echo '<table border="1">';
echo '<tr><td colspan="2" align="center"><h3>'."6A Top 5".'</h3></td></tr><tr><th>Team</td><th>Score</td><tr>';
asort($totals);
...
echo "<div class='CSSTableGenerator' >";
echo '<table border="1">';
echo '<tr><td colspan="2" align="center"><h3>'."5A Top 5".'</h3></td></tr><tr><th>Team</td><th>Score</td><tr>';
asort($totals);
foreach ($totals as $key => $val) {
    echo "<tr><td><h2>".$key."</h2></td><td><h2>".$val."</h2></td></tr>";
 }
...
echo "<div class='CSSTableGenerator' >";
echo '<table border="1">';
echo '<tr><td colspan="2" align="center"><h3>'."4A Top 5".'</h3></td></tr><tr><th>Team</td><th>Score</td><tr>';
asort($totals);
foreach ($totals as $key => $val) {
      echo "<tr><td><h2>".$key."</h2></td><td><h2>".$val."</h2></td></tr>";
 }
...
echo "<div class='CSSTableGenerator' >";
echo '<table border="1">';
echo '<tr><td colspan="2" align="center"><h3>'."321A Top 5".'</h3></td></tr><tr><th>Team</td><th>Score</td><tr>';
asort($totals);
foreach ($totals as $key => $val) {
        echo "<tr><td><h2>".$key."</h2></td><td><h2>".$val."</h2></td></tr>";
 }
...
?></td>
  ...
     
   ...
   <div align="center" ><h1><?php echo $name  ?> KCA Individual Rankings Top 10 by Class </h1>
   <br>
<?php
...
$query = "SELECT player_1, team, jv, avg(scores.total) as avg, classification FROM scores, team WHERE team.classification = '6A'
 AND team.school = scores.team   AND `jv` <> '".yes."'  GROUP by player_1 ORDER by avg asc  LIMIT 10 ";
$result = mysql_query($query)
...
<tr><th>Rank</td><th>Name</th><th>Team</th><th>Score</th><tr>';
