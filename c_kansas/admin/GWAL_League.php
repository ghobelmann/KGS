...
include_once("analyticstracking.php") 
 ?> 
        ...
        <h1><font color="white">Greater Wichita League Individual Standings</font></h1>
<?php
...
WHERE event = 'GWAL' AND jv != 'yes' group by s.pid 
order by points desc, total asc ";    
...
while($row = mysqli_fetch_array( $result )) {
	...
	echo "<tr><td>"; 
	echo '<a href="UpdateLeaguePointsGWAL.php?id='.$row['pid'].'">'.$row['pid'].'</font></a>';
  echo '</td><td><center>';
