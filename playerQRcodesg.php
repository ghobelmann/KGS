...
$tid = $_GET['tid'];
  ...
  $output = "http://admin.kansasgolfscores.com/playerQRcodesg.php?tid=$tid";
...
while($row = mysqli_fetch_array( $result )) {
	...
	echo "<tr> <center> <h1>";
	echo '<a href="mobileEntryFrontg.php?tid='.$row['tid'].'&db='.$db.'&card='.$row['card'].'">Card '.$row['card'].'</font></a>';
	echo "</tr>";
} 
echo "</table>";
