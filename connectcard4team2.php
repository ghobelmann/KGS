...
AND tid = $tournament AND round = 2;";
if($result = mysqli_query($conn,$sql)){
...
'$card1','$_POST[tid]', 
'$front1','$back1',
'$total1', '$data[id]', '$_POST[status1]', '2')";
...
'$card2','$_POST[tid]', 
'$front2','$back2',
'$total2', '$data[id]', '$_POST[status2]', '2')";
if (!mysqli_query($conn,$sql))
  {
...
'$card3','$_POST[tid]', 
'$front3','$back3',
'$total3', '$data[id]', '$_POST[status3]', '2')";
if (!mysqli_query($conn,$sql))
  {
...
'$card4','$_POST[tid]', 
'$front4','$back4',
'$total4', '$data[id]', '$_POST[status4]', '2')";
if (!mysqli_query($conn,$sql))
  {
...
'$card5','$_POST[tid]', 
'$front5','$back5',
'$total5', '$data[id]', '$_POST[status5]', '2')";
if (!mysqli_query($conn,$sql))
  {
...
'$card6','$_POST[tid]', 
'$front6','$back6',
'$total6', '$data[id]', '$_POST[status6]', '2')";
if (!mysqli_query($conn,$sql))
  {
