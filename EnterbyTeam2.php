...
?>
 ...
 <h4 class="card-header bg-dark">Round 2</h4>
...
WHERE roster.tmid = '$team' AND active = '2' 
AND grade > '2021' AND trnyteams.tid = '$tid'";
...
<form action="connectcard4team2.php" method="post" id="addForm">
...
Back 9: <input type="int" name="back1" size="2" value="0"/>  <br><br>
...
Back 9: <input type="int" name="back2" size="2" value="0"/>  <br><br>
...
Back 9: <input type="int" name="back3" size="2" value="0"/>  <br><br>
...
Back 9: <input type="int" name="back4" size="2" value="0"/>  <br><br>
...
Back 9: <input type="int" name="back5" size="2" value="0"/>  <br><br>
...
Back 9: <input type="int" name="back6" size="2" value="0"/>  <br><br>
