...
while($row = mysqli_fetch_array($result))
{
  ...
  //Daily Sub
        echo "<tr><td  style='color:#0000ff'>$row[pay_id]</td>";
        echo "<td style='color:#0000ff'>$row[pay]</td>";
        echo "<td style='color:#0000ff'>$row[job]</tr>";
}
}
