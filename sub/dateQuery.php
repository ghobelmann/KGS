...
while($row = mysqli_fetch_array($result))
{
  ...
  //Daily Sub
        echo "<center><tr><td><h1>Sub Report for: $row[date]</h1></td></center>";
}
}
...
<thead>
<tr><td>ID</td><td>Teacher</td><th>Sub</th><th>Date</th><th>Pay</th>
<th>Length</th><th>Type</th><td>Notes</td>
</tr>
</thead>
<tbody> 
<?php    
...
while($row = mysqli_fetch_array($result))
{
  ...
  //Daily Sub
  echo '<td><a href="editEntry.php?id='.$row['id'].'">'.$row['id'].'</font></a></td>';
  echo '<td><a href="teacherQuery.php?name_id='.$row['name_id'].'">'.$row['name'].'</font></a></td>';
  echo '<td><a href="subQuery.php?sub_id='.$row['sub_id'].'">'.$row['sub_name'].''.$row['tc_name'].'</font></a></td>';
        echo "<td>$row[date]</td>";
        echo "<td>$row[tc_pay]</td>";
        echo "<td>$row[length]</td>";
        echo "<td>$row[type]</td>";
        echo "<td style='text-align:left'>$row[notes]</td></tr>";
