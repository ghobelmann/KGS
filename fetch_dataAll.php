 ...
 include('databaseconnect.php');
   ...
   // avg((s.total-tr.rating)+ tr.par) as adj_score, 
...
//    echo $class_filter;
  ...
  if(isset($_POST["school"]))
 {
  ...
  $query .= "
   ...
   $query .= "GROUP by s.pid ORDER by total ASC LIMIT 100";
...
$i = 1;
	...
	echo "<tr><td>"; 
	echo $i.'</td><td>';
	echo '<a href="playerStats.php?pid='.$row['pid'].'&db=boys">'.$row['player_1'].'</a>';
    	echo "</td><td><CENTER>"; 
	echo $row['grade'];
   	echo "</td><td><CENTER>"; 
  	echo $row['countpl'];
	echo "</td><td><CENTER>"; 
	echo '<a href="teamStats.php?tmid='.$row['tmid'].'&db=boys">'.$row['abv'].'</a>';
  	echo "</td><td><CENTER>"; 
