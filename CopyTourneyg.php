...
include_once("dbconnectg.php");
 echo "You are logged in as $userid <br>"; 
...
<div id="wrapper">
  ...
  <div class="col-sm-1 mb-1"> 
    ...
    <div class="col-lg-8 mb-8">  
       ...
       <?php
$sql="SELECT max(id) as id, uid FROM tournament WHERE uid = $id";
...
<h1>Setup New Tournament</h1>
  ...
  <form action="connecttrnyCopyg.php" method="post">
  <h4>	<font color="red">
   State:   </font>
...
<h4>	<font color="red">
		...
		<input type="varchar" name="tournament" size="40" 
    value="<?php echo $tournament; ?>" required/></h4>
