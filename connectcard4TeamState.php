...
AND tid = $tournament AND round = 1;";
if($result = mysqli_query($conn,$sql)){
...
$tid = mysqli_fetch_assoc($result);
    ...
    $sql1 = "SELECT id FROM users WHERE users.email = '$_SESSION[email]'"; 
       ...
       //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[1]' AND tid = $tournament AND round = 2;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
	if(mysqli_num_rows($result)){
...
if(isset($_POST['man1'])){
    $man1= $_POST['man1'];
       ...
       $front21= false;
if(isset($_POST['front21'])){
    $front21= $_POST['front21'];
 } 
       $back21= false;
if(isset($_POST['back21'])){
    $back21= $_POST['back21'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
if(isset($_POST['status1'])){
 ...
 $total21 = $front21 + $back21;
  

    

$sql="INSERT INTO `scores` (pid, tmid, teetime, man,
card, tid, front, back, total, uid, status, round)
VALUES
('$_POST[1]','$tmid','$_POST[teetime1]',
'$man1',
'$card1','$_POST[tid]', 
'$front21','$back21',
'$total21', '$data[id]', '$_POST[status1]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 1 Insert' . mysqli_error($conn));
  }  }} }
...
//print_r ($uid); 
         //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[2]' AND tid = $tournament AND round = 2;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
	if(mysqli_num_rows($result)){
...
if(isset($_POST['man2'])){
    $man2= $_POST['man2'];
       ...
       $front22= false;
if(isset($_POST['front22'])){
    $front22= $_POST['front22'];
 } 
       $back22= false;
if(isset($_POST['back22'])){
    $back22= $_POST['back22'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
'$card2','$_POST[tid]', 
'$front22','$back22',
'$total22', '$data[id]', '$_POST[status2]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 22 Insert' . mysqli_error($conn));
  }
   }} }
...
//print_r ($uid);
 //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[3]' AND tid = $tournament AND round = 2;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
	if(mysqli_num_rows($result)){
		echo "<h1>ERROR: Player 23 has Already been Entered in the Database.</h1>";
	}else{
...
if(isset($_POST['man3'])){
    $man3= $_POST['man3'];
       ...
       $front23= false;
if(isset($_POST['front23'])){
    $front23= $_POST['front23'];
 } 
       $back23= false;
if(isset($_POST['back23'])){
    $back23= $_POST['back23'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
'$card3','$_POST[tid]', 
'$front23','$back23',
'$total23', '$data[id]', '$_POST[status3]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 23 Insert' . mysqli_error($conn));
  }
  }} }
...
//print_r ($uid); 
 ...
 //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[4]' AND tid = $tournament AND round = 2;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
	if(mysqli_num_rows($result)){
		echo "<h1>ERROR: Player 24 has Already been Entered in the Database.</h1>";
	}else{
...
if(isset($_POST['man4'])){
    $man4= $_POST['man4'];
       ...
       $front24= false;
if(isset($_POST['front24'])){
    $front24= $_POST['front24'];
 } 
       $back24= false;
if(isset($_POST['back24'])){
    $back24= $_POST['back24'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
'$card4','$_POST[tid]', 
'$front24','$back24',
'$total24', '$data[id]', '$_POST[status4]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 24 Insert' . mysqli_error($conn));
  }
  }} }
...
echo $check;
	if(mysqli_num_rows($result)){
		echo "<h1>ERROR: Player 25 has Already been Entered in the Database.</h1>";
	}else{
...
if(isset($_POST['man5'])){
    $man5= $_POST['man5'];
       ...
       $front25= false;
if(isset($_POST['front25'])){
    $front25= $_POST['front25'];
 } 
       $back25= false;
if(isset($_POST['back25'])){
    $back25= $_POST['back25'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
'$card5','$_POST[tid]', 
'$front25','$back25',
'$total25', '$data[id]', '$_POST[status5]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 25 Insert' . mysqli_error($conn));
  }
  }} }
...
echo $check;
	if(mysqli_num_rows($result)){
		echo "<h1>ERROR: Player 26 has Already been Entered in the Database.</h1>";
	}else{
...
if(isset($_POST['man6'])){
    $man6= $_POST['man6'];
       ...
       $front26= false;
if(isset($_POST['front26'])){
    $front26= $_POST['front26'];
 } 
       $back26= false;
if(isset($_POST['back26'])){
    $back26= $_POST['back26'];
 }  
               $tmid= false;
if(isset($_POST['tmid'])){
...
'$card6','$_POST[tid]', 
'$front26','$back26',
'$total26', '$data[id]', '$_POST[status6]', '2')";
if (!mysqli_query($conn,$sql))
  {
  die('Error: Player 26 Insert' . mysqli_error($conn));
  }
  }} }
