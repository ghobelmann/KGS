...
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
...
'$card1','$_POST[tid]', 
'$front1','$back1',
'$total1', '$data[id]', '$_POST[status1]', '4')";
...
//print_r ($uid); 
         //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[2]' 
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
...
'$card2','$_POST[tid]', 
'$front2','$back2',
'$total2', '$data[id]', '$_POST[status2]', '4')";
if (!mysqli_query($conn,$sql))
  {
...
//print_r ($uid);
 //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[3]' 
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
...
'$card3','$_POST[tid]', 
'$front3','$back3',
'$total3', '$data[id]', '$_POST[status3]', '4')";
if (!mysqli_query($conn,$sql))
  {
...
//print_r ($uid); 
 ...
 //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[4]' 
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
...
'$card4','$_POST[tid]', 
'$front4','$back4',
'$total4', '$data[id]', '$_POST[status4]', '4')";
if (!mysqli_query($conn,$sql))
  {
...
//print_r ($uid); 
   ...
   //check and see if already in tournament
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[5]' 
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
...
'$card5','$_POST[tid]', 
'$front5','$back5',
'$total5', '$data[id]', '$_POST[status5]', '4')";
if (!mysqli_query($conn,$sql))
  {
...
$sql = "SELECT scores.pid FROM scores WHERE pid = '$_POST[6]' 
AND tid = $tournament AND round = 4;";
if($result = mysqli_query($conn,$sql)){
$check = mysqli_num_rows($result);
echo $check;
...
'$card6','$_POST[tid]', 
'$front6','$back6',
'$total6', '$data[id]', '$_POST[status6]', '4')";
if (!mysqli_query($conn,$sql))
  {
