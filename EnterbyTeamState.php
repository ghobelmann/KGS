...
WHERE roster.tmid = '$team' AND active = '2' AND grade <= '12'  AND 
trnyteams.tid = '$tid'";
...
<form action="connectcard4TeamState.php" method="post" id="addForm">
...
Round 2 
Front 9: <input type="int" name="front21" size="2" value="0"/>
Back 9: <input type="int" name="back21" size="2" value="0"/>  <br><br>
<br><br>
...
Round 2 
Front 9: <input type="int" name="front22" size="2" value="0"/>
Back 9: <input type="int" name="back22" size="2" value="0"/>  <br><br>
<br><br>
...
Round 2 
Front 9: <input type="int" name="front23" size="2" value="0"/>
Back 9: <input type="int" name="back23" size="2" value="0"/>  <br><br>
<br><br>
...
Round 2 
Front 9: <input type="int" name="front24" size="2" value="0"/>
Back 9: <input type="int" name="back24" size="2" value="0"/>  <br><br>
<br><br>
...
Round 2 
Front 9: <input type="int" name="front25" size="2" value="0"/>
Back 9: <input type="int" name="back25" size="2" value="0"/>  <br><br>
<br><br>
...
Round 2 
Front 9: <input type="int" name="front26" size="2" value="0"/>
Back 9: <input type="int" name="back26" size="2" value="0"/>  <br><br>
<br><br>
