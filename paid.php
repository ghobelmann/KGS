...
?>
    <?php
	//This script is for the ranking
$sql = "SELECT * from team WHERE paid = 1 ORDER by state, school ASC ";
...
//Print table to the web page
echo "<table border='1'>";
echo "<tr> <th>Edit</th><th>School </th><th>Class</th><th>State</th><th>KCA</th><th>Amount</th><th>Delete</th> </tr>";
// keeps getting the next row until there are no more to get
