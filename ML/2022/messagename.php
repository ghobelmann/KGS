...
?>
      ...
      <h1 class="my-4"><center>Smith Center Mens League Player Stats
			</h1>
...
window.history.back();
    ...
    <center><h1 align="left">Search by Player <?php echo $name; ?></h1>
</center>
<?php
 // PHP Search Script
...
FROM scores WHERE player_1 = '$name' ORDER by mtch asc, team asc";
