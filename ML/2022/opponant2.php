...
if(!empty($_GET['rules1']))
{
$rules1 = $_GET['rules1'];
}
if(!empty($_GET['rules2']))
{
$rules2 = $_GET['rules2'];
}
?>
...
?>
  ...
  <tr>
   <td colspan="3"><div align="right" class="style2"><span class="style10">We will be playing the <?php echo $tees; ?> tees. </span></div></td>
    <td><div align="right" class="style2"><span class="style10">Net Score</span></div></td>
    ...
    <tr>
    <td colspan="4"><div align="right" class="style2"><span class="style10">Points</span></div></td>
    <td </td>   
    <td bordercolor="#000000" >&nbsp;</td>
    <td bordercolor="#000000">&nbsp;</td>
    <td bordercolor="#000000" >&nbsp;</td>
...
?>
  ...
  <tr><td colspan="14"><?php echo $rules1; ?></td></tr>
    <tr><td colspan="14"><?php echo $rules2; ?></td></tr>         
</table>  </table>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">A Match- <span class="style10"><?php echo $match  + 5?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">B Match- <span class="style10"><?php echo $match + 10?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">B Match- <span class="style10"><?php echo $match  + 11 ?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">B Match- <span class="style10"><?php echo $match  + 12 ?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">C Match- <span class="style10"><?php echo $match + 20?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  <tr>
    <td width="112">C Match- <span class="style10"><?php echo $match + 21 ?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
...
<tr colspan="14"><p>Smith Center Mens League</p></tr>
  ...
  <td bgcolor="#000000"><div align="left" class="style7 style6"><strong><span class="style2">
    <?php
//Select Players name from form 
if(!empty($_GET['team13']))
{
$team13 = $_GET['team13'];
}
$query = "SELECT schedule.*, schedule.team, scores.player_1, scores.team, avg(((((total) - 35.4) * 113) / 122.5)* .8) as hc1 FROM scores, 
schedule WHERE schedule.team = '$team13' 
AND scores.player_1 = schedule.c AND scores.sub <> 'yes' group by scores.player_1";
$result = mysqli_query($link, $query)
or die ('Error in Query Try Again:--' . mysqli_error());
...
?>
  ...
  <tr>
   ...
   <td bgcolor="#000000"><span class="style7 style6"><strong><span class="style2">
     <?php
//Select Players name from form 
if(!empty($_GET['team131']))
{
$team131 = $_GET['team131'];
}
$query = "SELECT schedule.*, schedule.team, scores.player_1, scores.team, avg(((((total) - 35.4) * 113) / 122.5)* .8) as hc1 FROM scores, 
schedule WHERE schedule.team = '$team131' 
AND scores.player_1 = schedule.c AND scores.sub <> 'yes'group by scores.player_1";
$result = mysqli_query($link, $query)
or die ('Error in Query Try Again:--' . mysqli_error());
...
<table width="950" border="1">  
  <tr>
    <td width="112">B vs C Match- <span class="style10"><?php echo $match + 23?></span></td>
    <td width="60"><p align="center" class="style10">HC</p>
    </td>  
    <td width="60"><div align="center"  class="style10">Strokes</div></td>
    <td width="60"><div align="center" class="style10">Team</div></td>
  ...
  <td bgcolor="#000000"><div align="left" class="style7 style6"><strong><span class="style2">
    <?php
//Select Players name from form 
if(!empty($_GET['team14']))
{
$team14 = $_GET['team14'];
}
$query = "SELECT schedule.*, schedule.team, scores.player_1, scores.team, avg(((((total) - 35.4) * 113) / 122.5)* .8) as hc1 FROM scores, 
schedule WHERE schedule.team = '$team14' 
AND scores.player_1 = schedule.c AND scores.sub <> 'yes' group by scores.player_1";
$result = mysqli_query($link, $query)
or die ('Error in Query Try Again:--' . mysqli_error());
...
?>
  ...
  <tr>
   ...
   <td bgcolor="#000000"><span class="style7 style6"><strong><span class="style2">
     <?php
//Select Players name from form 
if(!empty($_GET['team141']))
{
$team141 = $_GET['team141'];
}
$query = "SELECT schedule.*, schedule.team, scores.player_1, scores.team, avg(((((total) - 35.4) * 113) / 122.5)* .8) as hc1 FROM scores, 
schedule WHERE schedule.team = '$team141' 
AND scores.player_1 = schedule.c AND scores.sub <> 'yes'group by scores.player_1";
$result = mysqli_query($link, $query)
or die ('Error in Query Try Again:--' . mysqli_error());
