...
$query = "SELECT player_1, team, avg(hole9) as hole9 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole9 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 9</th><th>Team</th></tr>';
