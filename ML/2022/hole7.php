...
$query = "SELECT player_1, team, avg(hole7) as hole7 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole7 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 7</th><th>Team</th></tr>';
