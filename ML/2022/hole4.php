...
$query = "SELECT player_1, team, avg(hole4) as hole4 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole4 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 4</th><th>Team</th></tr>';
