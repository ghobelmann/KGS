...
$query = "SELECT player_1, team, avg(hole1) as hole1 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole1 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 1</th><th>Team</th></tr>';
