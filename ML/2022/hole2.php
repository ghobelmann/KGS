...
$query = "SELECT player_1, team, avg(hole2) as hole2 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole2 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 2</th><th>Team</th></tr>';
