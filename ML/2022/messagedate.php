...
?>
      ...
      <h1 class="my-4"><center>Smith Center Mens League
			</h1>
...
window.history.back();
    ...
    <center><h1 align="left">Search by Date <?php echo $date; ?></h1>
</center>
<?php
 // PHP Search Script
...
FROM scores WHERE date = '$date' ORDER by mtch asc, team asc";
...
<th>H 6</th> <th>H 7</th> <th>H 8</th> <th>H 9</th> <th>Total</th> </tr>";
...
?>
	...
	<?php $query = "SELECT AVG(hole1) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole2) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1); ?></td>
	<td align="center"><?php $query = "SELECT AVG(hole3) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1); ?></td>
	<td align="center"><?php $query = "SELECT AVG(hole4) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole5) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole6) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole7) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole8) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole9) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo round ($row['0'], 1);?></td>
	<td align="center"><?php $query = "SELECT AVG(hole1 + hole2 + hole3 + hole4 + hole5 + hole6 + hole7 + hole8 + hole9) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);?>
	<td align="center"><?php $query = "SELECT sum(points) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
...
<tr><td colspan="3">Shots Above or Below Par</td><td align="center">
	<?php $query = "SELECT AVG(total) FROM scores WHERE date = '$date' ";        
	$result = @mysqli_query ($conn, $query); // Run the query.
	$row = mysqli_fetch_array($result);
	echo 'NA';?></td>
	<td align="center"><?php $query = "SELECT AVG(hole2) FROM scores WHERE date = '$date' ";        
