...
$query = "SELECT player_1, team, avg(hole8) as hole8 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole8 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 8</th><th>Team</th></tr>';
