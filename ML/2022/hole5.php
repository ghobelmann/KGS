...
$query = "SELECT player_1, team, avg(hole5) as hole5 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole5 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 5</th><th>Team</th></tr>';
