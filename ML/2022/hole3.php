...
$query = "SELECT player_1, team, avg(hole3) as hole3 FROM scores WHERE scramble <> 'yes'  and sub <> 'yes' group by player_1 order by hole3 asc"; 
...
echo '<tr> <th>Place</th><th>Player</th> <th>Avg Hole 3</th><th>Team</th></tr>';
