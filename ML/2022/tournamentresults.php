  ...
  <body>
    <div id="page">
	  ...
	  <div id="header2">
	    ...
	    <div id="header2-slogan1"><p><?php echo $tournaments; ?></p></div>
...
echo "<h1>Results for $tournaments</h1>";

//Submit Query to MySql Database
$query = "SELECT * from trnyscores WHERE trny = '$tournaments' ORDER by total, back, front, last6, last3" ;
$result = mysql_query($query)
or die ('Error in Query Try Again:--' . mysql_error());

//Print table to the web page
echo "<table border='1' width='90%'>";
echo "<tr><th>Place</th> <th>Name </th><th>Team</th> <th>Tournament</th><th>Front</th><th>Back</th> <th>Total</th></tr>";
...
while($row = mysql_fetch_array( $result )) {
	...
	echo "<tr><td><center>"; 
	echo $i.'</td><td><center>';
	echo '<a href="trnyindividual.php?player_1='.$row['player_1'].'">'.$row['player_1'].'</font></a>';
	echo "</td><td><CENTER>"; 
	echo $row['team'];
	echo "</td><td><CENTER>"; 
	echo $row['trny'];
