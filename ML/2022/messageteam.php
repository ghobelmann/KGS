...
?>
      ...
      <h1 class="my-4"><center>Smith Center Mens League Team Stats
			</h1>
...
window.history.back();
    ...
    <center><h1 align="left">Search by Team <?php echo $team ; ?></h1>
</center>
<?php
 // PHP Search Script
...
FROM scores WHERE team = '$team' ORDER by mtch asc, team asc";
$result = mysqli_query($conn, $query)
or die ('Error in Query Try Again:--' . mysqli_error());

//Print table to the web page
echo "<table class='table'>";
echo "<tr> <th>Player Name </th><th>Match</th><th>H 1</th> <th>H 2</th> <th>H 3</th> <th>H 4</th> <th>H 5</th> 
