...
<head>    
    ...
    <meta content="Kansas boys and Boys Golf including scores, stats" name="description"/>
    ...
    <meta property="og:description" content="boys and Boys Golf including scores, stats Kansas" itemprop="description"/>
  ...
  <div>
  	<a class="navbar-brand" href="index.php?db=boys">Home</a>
    <a class="navbar-brand" href="trnysetup.php?db=boys">New Tournament</a>
    <a class="navbar-brand" href="enterroster.php?db=boys">Enter/Edit Roster</a>
    <a class="navbar-brand" href="editteam.php?db=boys">Edit School</a>
    <a class="navbar-brand" href="editcoach.php?db=boys">Edit Coach</a>
  <a class="navbar-brand" href="coachesdirectory.php" >Coaches</a>
  <a class="navbar-brand" href="EI/index.php">Invoice</a>
    <a class="navbar-brand" href="login-system/logout.php">Logout</a>
...
<meta name="theme-color" content="#ffffff">
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
               ...
               <a class="navbar-brand" href="teamRankingsAll.php?db=boys&state=ks" class="list-group-item"><font color="white">Rankings All</font></a>
            ...
            <a class="list-group-item"><color="white">Upload Team Logo</font></a>
        ...
        <a class="navbar-brand"  href="Setup Tournament Instructions.pdf"><font color="white">Setting Up Tournament Instructions</a>
         <a class="navbar-brand" href="roster6A.php?state=KS"><font color="white">Enter Roster for Schools</a> 
         
                  <a class="navbar-brand" href="tournaments.php"><font color="white">Other Tournaments</a>             
             </div>          
...
echo '<thead class="thead-dark">';
  ...
  echo '<div class="dropdown-content">';
    ...
    echo '<hr>';
    echo '<a href="copyteam.php?id='.$row['id'].'">Assign Teams to Tournament</font></a>';
    echo '<a href="selectteam.php?id='.$row['id'].'"">Assign Players to Cards</font></a>';
    echo '<a href="selectteamNoNames.php?id='.$row['id'].'"">Assign Players to Cards No Names</font></a>';
    echo '<hr>';
    echo '<a href="scoring/scorecards.php?id='.$row['id'].'">Print Scorecards Round 1 - Use Firefox</font></a>';
    echo '<a href="scoring/scorecards2.php?id='.$row['id'].'">Print Scorecards Round 2 Use Firefox</font></a>';  
    echo '<a href="scoring/scorecard9hole.php?id='.$row['id'].'">Print 9 Hole Card Use Firefox</font></a>';
    echo '<a href="scoring/scorecardsLong.php?id='.$row['id'].'">Print Long Scorecard Use Firefox</font></a>';  
    echo '<a href="scoring/scorecardNoNames.php?id='.$row['id'].'">No Names Scorecard Use Firefox</font></a>';  
    echo '<hr>';
    echo '<a href="http://www.kansasgolfscores.com/app/teeTimes2.php?id='.$row['id'].'">Overview</font></a>';
    echo '<a href="wallpages.php?id='.$row['id'].'">Team Sheets</font></a>';
    echo '<hr>';
    echo '<a href="scoring/scorecard.php?tid='.$row['id'].'">Enter Scores</font></a>'; 
    echo '<a href="scoring/cardtotal.php?tid='.$row['id'].'">Enter Front/Back</font></a>';
    echo '<a href="EnterbyTeamState.php?tid='.$row['id'].'">Enter 2 Round Tournaments</font></a>';   
    echo '<hr>';
    echo '<a href="editPlayer.php?tid='.$row['id'].'">Edit Cards - Status</font></a>';  
    echo '<a href="trnyroster.php?id='.$row['id'].'">View Golfers</font></a>';  
    echo '<a href="TourneybyHoles.php?tid='.$row['id'].'">Results</font></a>';
    echo '<a href=" teamresults246.php?tid='.$row['id'].'">246 Results</font></a>'; 
...
$result = mysqli_query($conn,$query) or die(mysqli_error());
 ...
 echo "<td><tr>";       
    ...
    echo '<font color="black"><h1> <strong>'.$row['tournament'].'</strong></h1>';
    echo '    <div class="profile-card-2 text-left">
    <a href="http://www.kansasgolfscores.com/tourneyResultsAll.php?tid='.$row['id'].'&db=boys">
    <img src="images/golf-tournament-logo.jpg ">
    </a>';
    echo '<div class="dropdown">';
