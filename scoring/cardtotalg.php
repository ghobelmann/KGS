...
include_once("cards_menutotalg.php");
 ?> <!DOCTYPE html>
<html lang="en">
<head>
...
while($row = mysqli_fetch_array( $result )) {
	...
	echo "<tr><td>"; 
  echo '<a href="cardtotalg.php?tid='.$trny.'&pid='.$row['pid'].'&'.card.'='.$card.'">'.$row['player_1'].'</font></a>';
	  echo "</td><td>";
    echo $row['school'];
    echo "</td><td>";
    echo $row['status'];
...
<table class="table">
  <tr>
      ...
      <td><div align="center" >Status <br>Codes: 1 = Varsity on a Team, 2 = Varsity Individual, 3 = JV, <br>4 = C team 
   5 = DQ, 6 = WD<br><input type="int" name="status" size="4" 
