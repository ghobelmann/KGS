...
<table class="table">
  <tr>
      ...
      <td><div align="center" >Status (5-DQ - 6-WD ) <input type="int" name="status" size="4" 
...
//Submit Query to MySql Database
  ...
  $result = mysqli_query($conn,$sql)
    ...
    <td><div align="center" >Front Round 1<input type="int" name="front" size="4" 
...
//Submit Query to MySql Database
  $sql = "SELECT scores.front, scores.tid, scores.round
  FROM scores 
  INNER JOIN tournament on scores.tid = tournament.id
  WHERE scores.tid = '$trny' AND pid = '$pid' AND round = '1' LIMIT 1 ";
  $result = mysqli_query($conn,$sql)
    ...
    <td><div align="center" >Back Round 1<input type="int" name="back" size="4" 
...
?>"/>  
    <td><div align="center" >Front Round 2 <input type="int" name="front2" size="4" 
...
//Submit Query to MySql Database
  ...
  FROM scores 
  INNER JOIN tournament on scores.tid = tournament.id
  WHERE scores.tid = '$trny' AND pid = '$pid' AND round = '2' LIMIT 1 ";
  $result = mysqli_query($conn,$sql)
    or die ('Error in Query Front 9 Try Again:--' . mysqli_error()); 
        while($row = mysqli_fetch_array( $result )) {
    echo $row['front']; 
    ...
    <td><div align="center" >Back Round 2<input type="int" name="back2" size="4" 
