...
$query = "SELECT *, stats.id, roster.player_1 FROM stats 
INNER JOIN tournament on stats.tid = tournament.id
LEFT JOIN roster on stats.tmid = roster.tmid
WHERE stats.pid = $id GROUP by stats.tid";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"> <a href="http://www.kansasgolfscores.com/playerStats.php?pid=<?php echo $pid; ?>">Home</a></li>
...
$(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       identifier:[0, 'id'],
       editable:[[2, 'tfairways'], [3, 'fairways'], [4,'gir'], [5, 'putts'], [6, 'Tputts'], [7, 'updownc'], [8, 'updown'], [9, 'ssc'], [10, 'ss'], [11, 'pen'], [12, 'ace'],  [13, 'dbleagle'], [14, 'eagle'], [15, 'birdie'], [16, 'par1'], [17, 'bogie'], [18, 'doubleb'], [19, 'triple'], [20, 'other'], [21, 'place'], [22, 'score'], [23, 'include']]
      },
      	autoFocus: true,
      restoreButton:true, 
      autoRefresh: true,
