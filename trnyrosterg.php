...
function goBack() {
  ...
  <div class="col-md-12">
      ...
      <ol class="breadcrumb">
        ...
        <a href="trnyRoster2g.php?id=<?php echo $tournament; ?>">Printable Version</a>
      </ol>
...
while($row = mysqli_fetch_array( $result )) {
  ...
  echo '<a href="wallpagesg.php?id='.$row['id'].'">'.$row['tournament'].'</font></a>';
      echo "</td><td><CENTER>"; 
  echo '<a href="scoring/scorecardg.php?tid='.$row['id'].'">Scorecard</font></a>';
	echo "</td></tr><CENTER>"; 
...
while($row = mysqli_fetch_array( $result )) {
	// Print out the contents of each row into a table
	echo "<tr><td>";
	echo '<a href="editg.php?id='.$row['id'].'">'.$row['id'].'</font></a>';
	echo "</td><td><CENTER>"; 
  	echo '<a href="editPlayerg.php?tid='.$row['tid'].'">'.$row['player_1'].'</font></a>';
	echo "</td><td><CENTER>"; 
	echo '<a href="teamStatsg.php?tmid='.$row['tmid'].'">'.$row['school'].'</font></a>';
    echo "</td><td><CENTER>";
  	echo $row['round'];
	echo "</td><td><CENTER>";
	echo $row['card'];
	...
	echo $row['man'];
     echo "</td><td><CENTER>";
	echo '<a href="deletevirtualscoresg.php?id='.$row['id'].'">'.$row['id'].'</font></a>';
	echo "</center></td></tr>"; 
