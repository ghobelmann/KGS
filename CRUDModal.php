                ...
                <form action="insertcode.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label> Name </label>
                            <input type="text" name="player_1" class="form-control" placeholder="Enter First Name">
                        </div>

                        <div class="form-group">
                            <label> TMID </label>
                            <input type="text" name="tmid" class="form-control" placeholder="tmid">
                        </div>
                ...
                <form action="updatecode.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="player_1" id="player_1" class="form-control"
                                placeholder="Enter First Name">
                        </div>

                        <div class="form-group">
                            <label> Last Name </label>
                            <input type="text" name="tmid" id="tmid" class="form-control"
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                $query = "SELECT * FROM roster WHERE tmid = '242'";
