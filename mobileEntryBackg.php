...
<?php 
  echo $tournament;
   echo '<a href="mobileEntryFrontg.php?tid='.$trny.'&card='.$card.'"><h3>Front Nine--</font></a>';
    echo '<a href="mobileEntryBackg.php?tid='.$trny.'&card='.$card.'">Back Nine</h3></font></a>';
 ?> </h3>
