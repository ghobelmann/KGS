    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          ...
          <h1>
        <a href='teamRankingsAllg.php?classification=6A'> <font color="black">6A-- </a> 
        
        <a href='teamRankingsAllg.php?classification=5A'> <font color="black">5A-- </a>
       <a href='teamRankingsAllg.php?classification=4A'> <font color="black">4A-- </a>
        <a href='teamRankingsAllg.php?classification=321A'><font color="black"> 321A </a> 
          </font>  </h1>
      </ol>
